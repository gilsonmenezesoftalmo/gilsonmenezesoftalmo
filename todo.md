# TODO - Redesign Tema B e C

## Redesign Solicitado
- [x] Implementar Tema B (Clínica Moderna) como tema escuro principal
...
- Primary: Ciano/Turquesa (#00d4ff)
- Accent: Azul claro (#4dd0e1)

## Paleta Tema C - Clássica Confortável (Light)
- Background: Cinza claro suave (#f5f5f5)
